...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-[30rem] justify-center space-x-10 overflow-y-auto overflow-x-hidden rounded-md px-10 scrollbar-hide"
      ref={ref}
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="mt-10">
              ...
              <motion.p
                ...
                className="text-kg max-w-sm text-slate-300"
              >
                {item.role}
              </motion.p>
              <motion.p
              ...
              <motion.div
                ...
                className="mt-5 flex space-x-1 flex-wrap"
              >
                {item.techstack?.map((tech) => (
                  <img
                    ...
                    src={`/skills/${tech}.svg`}
                    alt={tech}
                    className="h-10 w-10 rounded-full border border-slate-800 p-0.5"
                  />
                ))}
              </motion.div>
              <motion.div
              ...
              >
                ...
                {item.demoLink && (
                  <Link href={item.demoLink} target="_blank" rel="noreferrer">
                    <ShimmerButton className="shadow-2xl">
                      <span className="whitespace-nowrap text-center text-sm font-medium leading-none tracking-tight text-white dark:from-white dark:to-slate-900/10 lg:text-lg">
                        Live Demo
                      </span>
